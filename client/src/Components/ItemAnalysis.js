...
class ItemAnalysis extends Component{
  ...
  constructor(props){
    ...
    this.state = {
      ...
      itemanalysis_id: "",
      subject: props.location.state.subjectC,
      filename: props.location.state.filenameC,
      total_rawscore: 0,
      total_num_of_students: props.location.state.totalStudentsC,
      number_of_items: props.location.state.totalItemsC,
      mean: 0,
      students_above_mean: 0,
      students_equals_mean: 0,
      students_below_mean: 0,
      year: props.location.state.yearC,
      section: props.location.state.sectionC,
  ...
  createItems(){
    ...
    for (var i = 0; i < num_items; i++) {
      ...
      table_d.push( 
          <tr>
            <td >{i+1} </td>
            <td> <input type="number" min="0" max={this.state.total_num_of_students} onKeyPress={this.keypressHandler} key={i} id={i} defaultValue={0} onChange={this.itemHandler}></input> </td>
            <td>{this.state.rank[i]}</td>
            <td>{num_items-i} </td>
            <td> <input type="number" min="0" max={this.state.total_num_of_students} onKeyPress={this.keypressHandler} key={num_items-i} id={num_items-i} defaultValue={0} onChange={this.scoreHandler}></input> </td>
    ...
    table_d.push(
      <tr>
        ...
        <td></td>
        <td>0</td>
        <td> <input type="number" min="0" max={this.state.total_num_of_students} onKeyPress={this.keypressHandler} key={0} id={0} defaultValue={0} onChange={this.scoreHandler}></input> </td>
    ...
    return(
      ...
      <div class="feed"> 
        ...
        <div>
          ...
          <tbody>
            <tr>
            <td> <input type="text" key={10140} id={10140} onChange={this.filenameHandler} placeholder={"Untitled"} defaultValue={this.state.filename}></input> </td>
            </tr>
            <tr>
            <td ><b>Number of Items</b> <input type="number" min="0" onKeyPress={this.keypressHandler} key={10141} id={10141} onChange={this.numitemsHandler} defaultValue={this.state.number_of_items} placeholder={10}></input> </td>
              <td ><b>Total number of students</b> <input type="number" min="0" onKeyPress={this.keypressHandler} key={10141} id={10141} defaultValue={this.state.total_num_of_students} onChange={this.totalHandler}></input> </td>
              <td><b>Year Level</b><Select id="selectButton" onChange={this.yearHandler} options={yearOptions} placeholder={this.state.year} /> </td>
              <td> <b>Section</b> <input type="text" key={10142} id={10142} onChange={this.sectionHandler} defaultValue={this.state.section} placeholder={"Section"}></input> </td>
              <td><b>Subject</b><Select id="selectButton" onChange={this.subjectHandler} options={subjectOptions} placeholder={this.state.subject} /> </td>
            </tr>
            </tbody>
            </table>
            <table>
